...
static std::string help_manual =
    "Usage:\n"
    "   -c INPUT_CSV SCHEME_CSV OUTPUT_ISQ          Converts files\n"
    "   -q QUERY_NUM INPUT_ISQ OUTPUT_CSV           Requests queue\n"
    "   -l                                          Show the list "
    "of queries\n"
    "   -h                                          Open the user "
    "manual\n";
...
static std::vector<std::string> queries = {
    ...
    "COUNT(DISTINCT UserID) FROM hits GROUP BY RegionID ORDER BY c DESC LIMIT "
    "10",
    ...
    "WHERE URL <> '' GROUP BY CounterID HAVING COUNT(*) > 100000 ORDER BY l "
    "DESC LIMIT 25",
    ...
    "SUM(ResolutionWidth + 3), SUM(ResolutionWidth + 4), SUM(ResolutionWidth + "
    "5), "
    "SUM(ResolutionWidth + 6), SUM(ResolutionWidth + 7), SUM(ResolutionWidth + "
    "8), "
    "SUM(ResolutionWidth + 9), SUM(ResolutionWidth + 10), SUM(ResolutionWidth "
    "+ 11), "
    "SUM(ResolutionWidth + 12), SUM(ResolutionWidth + 13), SUM(ResolutionWidth "
    "+ 14), "
    "SUM(ResolutionWidth + 15), SUM(ResolutionWidth + 16), SUM(ResolutionWidth "
    "+ 17), "
    "SUM(ResolutionWidth + 18), SUM(ResolutionWidth + 19), SUM(ResolutionWidth "
    "+ 20), "
    "SUM(ResolutionWidth + 21), SUM(ResolutionWidth + 22), SUM(ResolutionWidth "
    "+ 23), "
    "SUM(ResolutionWidth + 24), SUM(ResolutionWidth + 25), SUM(ResolutionWidth "
    "+ 26), "
    ...
    "+ 35), "
    "SUM(ResolutionWidth + 36), SUM(ResolutionWidth + 37), SUM(ResolutionWidth "
    "+ 38), "
    "SUM(ResolutionWidth + 39), SUM(ResolutionWidth + 40), SUM(ResolutionWidth "
    "+ 41), "
    "SUM(ResolutionWidth + 42), SUM(ResolutionWidth + 43), SUM(ResolutionWidth "
    "+ 44), "
    "SUM(ResolutionWidth + 45), SUM(ResolutionWidth + 46), SUM(ResolutionWidth "
    "+ 47), "
    "SUM(ResolutionWidth + 48), SUM(ResolutionWidth + 49), SUM(ResolutionWidth "
    "+ 50), "
    "SUM(ResolutionWidth + 51), SUM(ResolutionWidth + 52), SUM(ResolutionWidth "
    "+ 53), "
    "SUM(ResolutionWidth + 54), SUM(ResolutionWidth + 55), SUM(ResolutionWidth "
    "+ 56), "
    "SUM(ResolutionWidth + 57), SUM(ResolutionWidth + 58), SUM(ResolutionWidth "
    "+ 59), "
    "SUM(ResolutionWidth + 60), SUM(ResolutionWidth + 61), SUM(ResolutionWidth "
    "+ 62), "
    "SUM(ResolutionWidth + 63), SUM(ResolutionWidth + 64), SUM(ResolutionWidth "
    "+ 65), "
    "SUM(ResolutionWidth + 66), SUM(ResolutionWidth + 67), SUM(ResolutionWidth "
    "+ 68), "
    "SUM(ResolutionWidth + 69), SUM(ResolutionWidth + 70), SUM(ResolutionWidth "
    "+ 71), "
    "SUM(ResolutionWidth + 72), SUM(ResolutionWidth + 73), SUM(ResolutionWidth "
    "+ 74), "
    "SUM(ResolutionWidth + 75), SUM(ResolutionWidth + 76), SUM(ResolutionWidth "
    "+ 77), "
    "SUM(ResolutionWidth + 78), SUM(ResolutionWidth + 79), SUM(ResolutionWidth "
    "+ 80), "
    ...
    "+ 86), "
    "SUM(ResolutionWidth + 87), SUM(ResolutionWidth + 88), SUM(ResolutionWidth "
    "+ 89) FROM hits",
    ...
    "FROM hits "
    "GROUP BY ClientIP, ClientIP - 1, ClientIP - 2, ClientIP - 3 ORDER BY c "
    "DESC LIMIT 10",
    ...
    "GROUP BY WindowClientWidth, WindowClientHeight ORDER BY PageViews DESC "
    "LIMIT 10 OFFSET 10000",
    "SELECT DATE_FORMAT(EventTime, '%Y-%m-%d %H:00:00') AS M, COUNT(*) AS "
    "PageViews "
    "FROM hits WHERE CounterID = 62 AND EventDate >= '2013-07-14' AND "
    "EventDate <= '2013-07-15' "
    "AND IsRefresh = 0 AND DontCountHits = 0 "
    "GROUP BY DATE_FORMAT(EventTime, '%Y-%m-%d %H:00:00') "
    "ORDER BY DATE_FORMAT(EventTime, '%Y-%m-%d %H:00:00') LIMIT 10 OFFSET "
    "1000"};
